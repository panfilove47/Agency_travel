...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->login_button->Size = System::Drawing::Size(117, 20);
			...
			this->reg_button->Size = System::Drawing::Size(117, 20);
			this->reg_button->TabIndex = 2;
			this->reg_button->Text = L"Регистрация";
			this->reg_button->UseVisualStyleBackColor = true;
			this->reg_button->Click += gcnew System::EventHandler(this, &MyForm::reg_button_Click);
			// 
			// label1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Arial", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->Location = System::Drawing::Point(256, 22);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(73, 22);
			...
			this->label2->Location = System::Drawing::Point(247, 125);
			...
			this->login_box->TextChanged += gcnew System::EventHandler(this, &MyForm::login_box_TextChanged);
			// 
			// password_box
			// 
			...
			this->password_box->TextChanged += gcnew System::EventHandler(this, &MyForm::password_box_TextChanged);
			// 
			// error_label
			// 
...
#pragma endregion
	...
	private: System::Void password_box_TextChanged(System::Object^ sender, System::EventArgs^ e);
	private: System::Void login_box_TextChanged(System::Object^ sender, System::EventArgs^ e);
};
}
